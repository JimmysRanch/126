...
import { ChartCard, SimpleFunnelChart, SimpleBarChart } from '../components/ChartChart'
...
export function RetentionRebooking() {
  ...
  const tableData = useMemo(() => {
    ...
    return measurePerformance('aggregateRetentionTable', () =>
      aggregateRetentionBySegment(appointments, clients, groupBy as any)
    )
  ...
  const formatDays = (v: number) => `${v.toFixed(0)} days`
